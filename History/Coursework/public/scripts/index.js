$(function() {
    ...
    // Loading the top 5 movies from different genres into the index page
...
// the function fetches the top 5 movies of a genre from TMDB with a given genre id
// the user variable is used to put the username in the links to other pages
// the genre variable is supplied in order to access the genre name
